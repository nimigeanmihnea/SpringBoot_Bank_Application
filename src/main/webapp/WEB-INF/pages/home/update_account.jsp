...
<body onload='document.loginForm.username.focus();'>
	<div class="update_account">
            <form action = "/home/updateaccount" method="POST">
    			    	<input type="text" value='${account.accountType}' name="accountType" placeholder="Type"  required="required"/>
                        <input type="text" value='${account.accountBalance}' name="accountBalance" placeholder="Balance"  required="required" />
                        <input type="hidden" value='${account.accountId}' name = "search"/>
